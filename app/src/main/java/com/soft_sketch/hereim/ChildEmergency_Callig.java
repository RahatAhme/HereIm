...
public class ChildEmergency_Callig extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((ChildActivity) getActivity()).setTitle("Emergency Calling");
        ...
        parentCallBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:" + GetParentNumber(((ChildActivity) getActivity()).childID)));
    ...
    private String GetParentNumber(String childID) {
        String parentNumbe="";
        return dataBase.GetParentPhone(childID);
    }
